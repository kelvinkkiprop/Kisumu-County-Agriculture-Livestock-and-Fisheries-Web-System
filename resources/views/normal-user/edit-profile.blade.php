...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
            <form enctype="multipart/form-data" method="POST" action="/profile/{{$profile->id}}/update">
                @csrf     
                <div class="card-header"><i class="fa fa-pen fa-2x" aria-hidden="true">&nbsp;{{ __('Edit profile') }}</i></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    name="picture" value="{{$profile->picture}}">
